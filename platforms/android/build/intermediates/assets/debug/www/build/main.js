...
DetailArticlePage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__angular_platform_browser__["c" /* DomSanitizer */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
], DetailArticlePage);
...
var AfriquePage = (function (_super) {
    ...
    function AfriquePage(navCtrl, navParams, rest) {
        var _this = _super.call(this, navCtrl, rest) || this;
...
AfriquePage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__providers_rest_data_rest_data__["a" /* RestDataProvider */]])
], AfriquePage);
...
var PolitiquePage = (function (_super) {
    ...
    function PolitiquePage(navCtrl, navParams, rest) {
        var _this = _super.call(this, navCtrl, rest) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.rest = rest;
...
PolitiquePage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_rest_data_rest_data__["a" /* RestDataProvider */]])
], PolitiquePage);
...
var ActuPage = (function (_super) {
    ...
    function ActuPage(navCtrl, navParams, rest) {
        var _this = _super.call(this, navCtrl, rest) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.rest = rest;
...
var InternationnalPage = (function (_super) {
    ...
    function InternationnalPage(navCtrl, navParams, rest) {
        var _this = _super.call(this, navCtrl, rest) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.rest = rest;
...
var CulturePage = (function (_super) {
    ...
    function CulturePage(navCtrl, navParams, rest) {
        var _this = _super.call(this, navCtrl, rest) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.rest = rest;
...
var LifestylePage = (function (_super) {
    ...
    function LifestylePage(navCtrl, navParams, rest) {
        var _this = _super.call(this, navCtrl, rest) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.rest = rest;
...
var SantePage = (function (_super) {
    ...
    function SantePage(navCtrl, navParams, rest) {
        var _this = _super.call(this, navCtrl, rest) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.rest = rest;
...
var SportPage = (function (_super) {
    ...
    function SportPage(navCtrl, navParams, rest) {
        var _this = _super.call(this, navCtrl, rest) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.rest = rest;
...
var FemmePage = (function (_super) {
    ...
    function FemmePage(navCtrl, navParams, rest) {
        var _this = _super.call(this, navCtrl, rest) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.rest = rest;
...
var JusticePage = (function (_super) {
    ...
    function JusticePage(navCtrl, navParams, rest) {
        var _this = _super.call(this, navCtrl, rest) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.rest = rest;
